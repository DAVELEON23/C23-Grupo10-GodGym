...
export default  function ContentRouteMovie({countUser,countProduct,countCategory}) { //Seguir agregando propiedades para los contadores
    return(
		<div className="row">
								...
								<div className="card-body">
									<div className="row no-gutters align-items-center">
										<div className="col mr-2">
											...
											<div className="h5 mb-0 font-weight-bold text-gray-800">{countCategory}</div>
										</div>
										<div className="col-auto">
